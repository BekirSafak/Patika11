function newElement() {
  ...
  if (newTask.value.trim().length > 0) { // ! .trim() boşluk karekterinin girilmesini önledi.
    //* Yeni li etiketinin,span etiketinin(X), classın olusturulmasi
...
function deleteTodoData(newSpan, newLi) {
  // * Span("X") tiklanınca silme islemi
